...
<body>
	...
	<dvi class="ALLES">
		...
		<main>
			...
			<div>
				<img class="INFOBLASE-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_titan.php'" src="../../images/InfoBlase.png" alt="Infoblase">
				<p class="INFOTEXT-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_titan.php'">
					Erfahre mehr <br>
					über Windkraft!
				</p>
			</div>
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT-WIND">
						...
						<br><br>
						<button  class="BTNLINKS-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_titan.php'">Zum Retterwissen Windenergie</button>
