...
<body>
	...
	<div class="ALLES">
		...
		<main>
			...
			<div>
				<img class="INFOBLASE-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_sonic.php'" src="../../images/InfoBlase.png" alt="Infoblase">
				<p class="INFOTEXT-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_sonic.php'">
					Erfahre mehr <br>
					über Windkraft!
				</p>
			</div>
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT-WIND">
						...
						<br><br>
						<button  class="BTNLINKS-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_sonic.php'">Zum Retterwissen Windenergie</button>
