...
<body>
	...
	<div class="ALLES">
		...
		<main>
			...
			<div>
				<img class="INFOBLASE-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_scarlet.php'" src="../../images/InfoBlase.png" alt="Infoblase">
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT-WIND">
						...
						<br><br>
						<button  class="BTNLINKS-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_scarlet.php'">Zum Retterwissen Windenergie</button>
