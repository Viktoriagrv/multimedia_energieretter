	...
	<div class="ALLES">
		...
		<main>
			...
			<div>
				...
				<p class="INFOTEXT-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_blaze.php'">
					Erfahre mehr <br>
					über Windkraft!
				</p>
			</div>
			...
			<div class="ABSCHLUSSTEXT-KAPITELSTART">
				<button  class="BTNLINKS-WIND" onclick="window.location.href='karte_wind_blaze.php'">Zur Weltkarte</button>
			</div>	
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT-WIND">
						...
						<br><br>
						<button  class="BTNLINKS-WIND" onclick="window.location.href='../../retterwissen/zukunftsenergien/wind/wind_blaze.php'">Zum Retterwissen Windenergie</button>
