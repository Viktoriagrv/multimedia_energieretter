...
<body>
	...
	<div class="ALLES">
		...
		<main>
			...
			<div>
				<img class="INFOBLASE" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar/solar_scarlet.php'" src="../../images/InfoBlase.png" alt="Infoblase">
				<p class="INFOTEXT" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar/solar_scarlet.php'">
					Erfahre mehr <br>
					über Solarenergie!
				</p>
			</div>
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT">
						...
						<br><br>
						<button  class="BTNLINKS" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar/solar_scarlet.php'">Zum Retterwissen Solarenergie</button>
