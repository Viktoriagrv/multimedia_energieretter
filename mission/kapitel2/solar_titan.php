...
<body>
	...
	<div class="ALLES">
		...
		<main>
			...
			<div>
				<img class="INFOBLASE" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar/solar_titan.php'" src="../../images/InfoBlase.png" alt="Infoblase">
				<p class="INFOTEXT" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar/solar_titan.php'">
					Erfahre mehr <br>
					über Solarenergie!
				</p>
			</div>
			...
			<div class="ABSCHLUSSTEXT-KAPITELSTART">
				<button  class="BTNLINKS" onclick="window.location.href='karte_solar_titan.php'">Zur Weltkarte</button>
			</div>
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT">
						...
						<br><br>
						<button  class="BTNLINKS" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar/solar_titan.php'">Zum Retterwissen Solarenergie</button>
