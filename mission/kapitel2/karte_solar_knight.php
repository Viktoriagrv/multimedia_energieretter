	...
	<div class="ALLES">
		...
		<main>
			...
			<div class="INFOBOX-WEITER">
				...
				<button class="BTNWEITER" onclick="window.location.href='../kapitel3/wasser_knight.php'">Auf zum nächsten Kapitel!</button>
			</div>
