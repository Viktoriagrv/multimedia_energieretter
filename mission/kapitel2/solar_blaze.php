...
<body>
    ...
    <main>
		...
		<div>
			<img class="INFOBLASE" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar_blaze.php'" src="../../images/InfoBlase.png" alt="Infoblase">
			<p class="INFOTEXT" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar_blaze.php'">
				Erfahre mehr <br>
				über Solarenergie!
			</p>
		</div>
		...
		<div class="FEHLERMELDUNG">
				...
				<div class="TEXT">
					...
					<br><br>
					<button  class="BTNLINKS" onclick="window.location.href='../../retterwissen/zukunftsenergien/solar_blaze.php'">Zum Retterwissen Solarenergie</button>
