...
<body>
	...
	<div class="ALLES">
		...
		<main>
			...
			<div class="INFOBOX-WEITER">
				...
				<button class="BTNWEITER" onclick="window.location.href='../kapitel3/wasser_thunder.php'">Auf zum nächsten Kapitel!</button>
			</div>
	...
	<script>
		...
		function AlleAbgelegt(){
			document.querySelector(".THUNDER-KARTE").classList.remove("ZEIGEN");
			document.querySelector(".SPRECHBLASE1").classList.remove("ZEIGEN");
