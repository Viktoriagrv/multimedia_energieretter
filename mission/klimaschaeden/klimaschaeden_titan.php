...
<body>
		...
		<main>
			...
			<div class="INFOBOX-KLIMA">
				...
				<div class="TEXT-KLIMA">
					Hallo! <br>
					Ich bin Cyber Titan. Ich freue mich, dass du mit mir auf diese Mission gehen möchtest. <br>
	...
	<script>
		...
		document.querySelector(".TITAN").addEventListener("mouseover", BlackScreenDa);
			document.querySelector(".TITAN").addEventListener("mouseout", BlackScreenWeg);
		...
		document.querySelector(".KARTE-ANSEHEN").addEventListener("click",ZeigeWeltkarte);
			...
			function ZeigeWeltkarte(){
				...
				document.querySelector(".KARTE-ANSEHEN").classList.add("WEG");
				document.querySelector(".TITAN").classList.add("ZEIGEN");
