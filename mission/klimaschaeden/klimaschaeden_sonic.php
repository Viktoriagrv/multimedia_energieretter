		...
		<main>
			...
			<div class="INFOBOX-KLIMA">
				...
				<div class="TEXT-KLIMA">
					Hallo! <br>
					Ich bin Sonic Shield. Ich freue mich, dass du mit mir auf diese Mission gehen möchtest. <br>
	...
	<script>
		...
		document.querySelector(".KARTE-ANSEHEN").addEventListener("click",ZeigeWeltkarte);
			...
			function ZeigeWeltkarte(){
				...
				document.querySelector(".SONIC").classList.add("ZEIGEN");
				document.querySelector(".SPRECHBLASE-KLIMA").classList.add("ZEIGEN");
				document.querySelector(".LOS-KLIMA").classList.add("ZEIGEN");
			}
		
		
		document.querySelector(".SONIC").addEventListener("mouseover",SchutzschildGrossDa);
					document.querySelector(".SONIC").addEventListener("mouseout",SchutzschildGrossWeg);
