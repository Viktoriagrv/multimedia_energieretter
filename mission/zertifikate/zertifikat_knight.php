	...
	<div class="ALLES">
		...
		<main>
			...
			<div class="INFOBOX-KLIMA">
				...
				<img  class="ZERTIFIKAT" src="../../images/urkunde_knight.png" alt="Urkunde als Energieretter">
				<br>
				<a href="../../images/urkunde_knight.pdf" download><button class="BTNDOWNLOAD">Download Urkunde</button></a>
