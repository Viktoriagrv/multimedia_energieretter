	...
	<div class="ALLES">
		...
		<main>
			...
			<div class="INFOBOX-KLIMA">
				...
				<img  class="ZERTIFIKAT" src="../../images/urkunde_thunder.png" alt="Urkunde als Energieretter">
				<br>
				<a href="../../images/urkunde_thunder.pdf" download><button class="BTNDOWNLOAD">Download Urkunde</button></a>
