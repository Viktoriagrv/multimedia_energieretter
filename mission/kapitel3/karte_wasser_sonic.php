	...
	<div class="ALLES">
		...
		<main>
			...
			<div class="INFOBOX-ABSCHLUSS">
				...
				<img class="BILDINFOBOX-ABSCHLUSS" src="../../images/BadBoy.png" alt="Sonic Shield">
				...
				<button class="BTNABSCHLUSS" onclick="window.location.href='../zertifikate/zertifikat_sonic.php'">Zu Deiner Urkunde</button>
			</div>
