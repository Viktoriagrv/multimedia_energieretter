...
<body>
	...
	<div class="ALLES">
		...
		<main>
			...
			<div>
				<img class="INFOBLASE-WASSER" onclick="window.location.href='../../retterwissen/zukunftsenergien/wasser/wasser_blaze.php'" src="../../images/InfoBlase.png" alt="Infoblase">
				<p class="INFOTEXT-WASSER" onclick="window.location.href='../../retterwissen/zukunftsenergien/wasser/wasser_blaze.php'">
					Erfahre mehr <br>
					über Wasserkraft!
				</p>
			</div>
			...
			<div class="ABSCHLUSSTEXT-KAPITELSTART">
				<button  class="BTNLINKS-WASSER" onclick="window.location.href='karte_wasser_blaze.php'">Zur Weltkarte</button>
			</div>
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT-WASSER">
						...
						<br><br>
						<button  class="BTNLINKS-WASSER" onclick="window.location.href='../../retterwissen/zukunftsenergien/wasser/wasser_blaze.php'">Zum Retterwissen Wasserkraft</button>
