...
<body>
    ...
    <main>
		...
		<div class="INFOBOX-ABSCHLUSS">
			...
			<img class="BILDINFOBOX-ABSCHLUSS" src="../../images/Biest.png" alt="Cyber Titan">
			...
			<button class="BTNABSCHLUSS" onclick="window.location.href='../zertifikate/zertifikat_titan.php'">Zu Deiner Urkunde</button>
		</div>
