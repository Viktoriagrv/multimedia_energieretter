...
<body>
	...
	<div class="ALLES">
		...
		<main>
			...
			<div>
				<img class="INFOBLASE-WASSER" onclick="window.location.href='../../retterwissen/zukunftsenergien/wasser/wasser_thunder.php'" src="../../images/InfoBlase.png" alt="Infoblase">
				<p class="INFOTEXT-WASSER" onclick="window.location.href='../../retterwissen/zukunftsenergien/wasser/wasser_thunder.php'">
					Erfahre mehr <br>
					über Wasserkraft!
				</p>
			</div>
			...
			<div class="ABSCHLUSSTEXT-KAPITELSTART">
				<button  class="BTNLINKS-WASSER" onclick="window.location.href='karte_wasser_thunder.php'">Zur Weltkarte</button>
			</div>
			...
			<div class="FEHLERMELDUNG">
					...
					<div class="TEXT-WASSER">
						...
						<br><br>
						<button  class="BTNLINKS-WASSER" onclick="window.location.href='../../retterwissen/zukunftsenergien/wasser/wasser_thunder.php'">Zum Retterwissen Wasserkraft</button>
