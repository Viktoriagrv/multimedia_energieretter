...
<body>
    ...
    <main>
		...
		<div class="INFOBOX-ABSCHLUSS">
			...
			<img class="BILDINFOBOX-ABSCHLUSS" src="../../images/Prinzessin.png" alt="Green Blaze">
			...
			<button class="BTNABSCHLUSS" onclick="window.location.href='../zertifikate/zertifikat_blaze.php'">Zu Deiner Urkunde</button>
		</div>
